...
const SELLER_REVIEWS: { rating: number; comment: string }[] = [
  ...
  { rating: 4, comment: "No complaints. Description was accurate, price was fair." },
  { rating: 5, comment: "Was upfront that the account had been idle for a year. Everything else was exactly right." },
  { rating: 2, comment: "Squad had been stripped since the screenshots. Admin refunded me in full, so the system worked, but be careful." },
  ...
  { rating: 5, comment: "Honest about a previous ban that had been lifted. Told me before I paid, not after." },
  { rating: 4, comment: "Account was good. Would use again." },
  { rating: 5, comment: "No games, no last-minute price changes. Exactly what was agreed." },
...
const BUYER_REVIEWS: { rating: number; comment: string }[] = [
  ...
  { rating: 5, comment: "Paid before I had even finished depositing the account." },
  ...
  { rating: 3, comment: "Paid late and went quiet for a day, but did confirm properly in the end." },
  ...
  { rating: 4, comment: "Good. Needed a bit of hand-holding through the payment step." },
  { rating: 5, comment: "Paid the exact amount to the right network first time, which not everyone manages." },
  ...
  { rating: 4, comment: "All good. Slight delay on payment but he kept me updated." },
  ...
  { rating: 5, comment: "Paid quickly and left a fair review. Nothing more you can ask." },
  ...
  { rating: 5, comment: "No haggling, no drama, paid and confirmed." },
